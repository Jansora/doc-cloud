...
```
    ...
    <Tab>
```
root@u1:~# sudo apt install nfs-kernel-server
...
```
root@u1:~# sudo cat /proc/fs/nfsd/versions
-2 +3 +4 +4.1 +4.2
```
...
```
# 192.168.88.11 为 U1 的 ip

mkdir -p /mnt/nfs

mount 192.168.88.11:/nfs /mnt/nfs
```

3. 在 `U2` 共享目录下创建文件进行验证

```
root@u2:/mnt/nfs# echo 'hello, nfs!' > test.txt
```
...
root@u1:/nfs# cat test.txt
hello, nfs!
```

验证成功!!

## [U2, U3] 挂载 NFS 并配置开机启动
...
```
192.168.88.11:/nfs /mnt/nfs nfs default 0 0
```
...
192.168.88.11:/nfs   47G  6.8G   38G  16% /mnt/nfs
tmpfs               393M  4.0K  393M   1% /run/user/0
root@u2:~# cd /mnt/nfs/
root@u2:/mnt/nfs# ls -l
total 4
-rw-r--r-- 1 nobody nogroup 12 May 10 15:11 test.txt
root@u2:/mnt/nfs# cat test.txt
hello, nfs!
root@u2:/mnt/nfs#
```
