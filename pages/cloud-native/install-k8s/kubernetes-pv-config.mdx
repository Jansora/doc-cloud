...
root@u1:/mnt# kubectl get pods -n kube-system | grep nfs-client
...
root@u1:/mnt/nfs# cd kubernetes/
root@u1:/mnt/nfs/kubernetes# ls -l
total 8
...
root@u1:/mnt/nfs/kubernetes# cd default-test-pvc-pvc-4214a4a0-cc2a-41df-9251-9e08ed536e8b/
root@u1:/mnt/nfs/kubernetes/default-test-pvc-pvc-4214a4a0-cc2a-41df-9251-9e08ed536e8b# ls -l
total 0
