...
```
    ...
    kubeadm join 192.168.88.11:6443 --token yqutyd.nlrmqhnqoi0wkjxn \
    --discovery-token-ca-cert-hash sha256:e84c7c70ee156367d97bdaa6fe39c658d44efaaaddd2cef115400f70a9e1101d
```
</Tab>
</Tabs>
